...
const Tables = () => {
  ...
  const fetchTables = async () => {
    try {
      const res = await axios.get("https://foodapp-server-t1i3.onrender.com/api/food/tables");
      setTables(res.data);
    } catch (err) {
  ...
  const handleCreateTable = async () => {
    try {
      const res = await axios.post("https://foodapp-server-t1i3.onrender.com/api/food/tables", {
  ...
  const handleDeleteTable = async (id) => {
    try {
      const res = await axios.delete(`https://foodapp-server-t1i3.onrender.com/api/food/tables/${id}`);
      if (res.status === 200) {
